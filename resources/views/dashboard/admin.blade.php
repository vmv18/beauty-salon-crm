...
<head>
    ...
    <title>Панель адміністратора - Beauty Salon CRM</title>
...
<body>
    <section class="section">
        <div class="container">
            <div class="box">
                <h1 class="title is-3 has-text-primary">👑 Панель адміністратора</h1>
                ...
                <p class="mb-4">Ви маєте повний доступ до всіх функцій системи.</p>
