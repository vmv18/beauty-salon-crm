...
@section('title', 'Додати клієнта - Beauty Salon CRM')
...
@section('content')
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-md">
        ...
        <h1 class="text-3xl font-bold text-purple-600 mb-8">➕ Додати нового клієнта</h1>
        ...
        <form method="POST" action="{{ route('clients.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="phone" name="phone" value="{{ old('phone') }}" placeholder="+380XXXXXXXXX" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-200">
                @error('phone')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="email@example.com" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-200">
                @error('email')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-200">
                @error('date_of_birth')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="address" name="address" placeholder="Повна адреса клієнта" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white resize-y min-h-[100px] focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-200">{{ old('address') }}</textarea>
                @error('address')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea id="notes" name="notes" placeholder="Додаткові примітки про клієнта" class="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white resize-y min-h-[100px] focus:outline-none focus:border-purple-600 focus:ring-2 focus:ring-purple-200">{{ old('notes') }}</textarea>
                @error('notes')
                    <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
